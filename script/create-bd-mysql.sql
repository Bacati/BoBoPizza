...
-- ALTER TABLE COMMANDE DROP FOREIGN KEY COMMANDE_CLIENT_FK;
-- ALTER TABLE COMMANDE DROP FOREIGN KEY COMMANDE_ETAT_FK;
-- ALTER TABLE COMMANDE DROP FOREIGN KEY COMMANDE_UTILISATEUR_FK;
...
-- ALTER TABLE UTILISATEUR DROP FOREIGN KEY UTILISATEUR_COMMANDE_FK;
